...
public class RxSchedulersOverrideRule implements TestRule {
    ...
    public final RxJavaSchedulersHook mRxJavaSchedulersHook = new RxJavaSchedulersHook() {
        @Override
    ...
    public final RxAndroidSchedulersHook mRxAndroidSchedulersHook = new RxAndroidSchedulersHook() {
        @Override
    ...
    public void callResetViaReflectionIn(RxJavaPlugins rxJavaPlugins)
